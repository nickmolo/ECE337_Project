...
COMPONENT_FILES	:= buffer.sv clockdivider.sv flex_counter.sv hs_sr.sv output_controller.sv outputMux.sv pixel_gen.sv sr_mux.sv stage_2.sv stageOne.sv tmds_controller.sv TMDS_Encoder.sv timertop.sv addr_bit_flip.sv
